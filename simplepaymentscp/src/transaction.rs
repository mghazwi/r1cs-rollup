...
use crate::signature::{schnorr::{self, Schnorr}};
...
impl Transaction {
    ...
    pub fn create<R: Rng>(
        ...
        let signature = Schnorr::sign(&parameters.sig_params, sender_sk, &sender_pk, &message, rng).unwrap();
        Self {
            sender,
            recipient,
            amount,
